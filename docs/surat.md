...
1. [Surat Pengantar Tugas Akhir](https://toss.telkomuniversity.ac.id)
1. [Surat Dispensasi](https://toss.telkomuniversity.ac.id)
1. [Surat Rekomendasi Beasiswa](https://toss.telkomuniversity.ac.id)
1. [Surat Berkelakuan Baik](https://toss.telkomuniversity.ac.id)

## **Tata Cara Pengajuan**

Login ke [TOSS](https://toss.telkomuniversity.ac.id/login).
...
![](https://raw.githubusercontent.com/s1trm/knowledge/refs/heads/master/gambar/toss3.png)
